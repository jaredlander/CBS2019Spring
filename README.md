...
``` r
newProject <- usethis::use_course('https://github.com/jaredlander/CBS2019Spring/archive/master.zip')
```
...
CBS2019Spring. You can see this in the top right of RStudio (the name in
